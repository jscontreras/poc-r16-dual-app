...
function initializeSearchApps() {
  ...
  if (searchBarContainer) {
    ReactDOM.render(
      <React.StrictMode>
        <AutocompleteApp catalogs={catalogs} catalogLabel={'Select Catalog'} insightsClient={insightsClient} searchClient={searchClient} />
      </React.StrictMode>,
      searchBarContainer
    );
  }
  ...
  const searchAppContainer = document.getElementById("search-results__container");
